...
function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (trimmedName.length < 2 || trimmedName.length > 15) {
      console.error("Name must be between 2 and 15 characters");
      return;
    }
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-gradient-to-br from-blue-900/70 via-purple-900/80 to-indigo-900/70 animate-pulse"
        ...
        <div className="md:w-1/2 p-8 pt-8 flex flex-col justify-center bg-gradient-to-br from-purple-600/90 to-blue-500/90 backdrop-blur-sm text-white max-h-[32rem] overflow-auto relative">
          <div className="relative z-10">
            ...
            <p className="mb-6 text-lg leading-relaxed opacity-90">
              Step into a <span className="font-semibold text-yellow-300">multiplayer virtual world</span>! Move around,
              chat with nearby players, and experience a revolutionary kind of online interaction.
            </p>
          ...
          <div className="relative z-10">
            <div className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-800 mb-2 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text">
                  Enter the Metaverse
                </h2>
              ...
              <div className="text-center space-y-2 pt-4">
                <p className="text-xs text-gray-500">✅ Works on any website • 🔒 No registration required</p>
